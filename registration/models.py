...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    access_adminpanel = models.BooleanField(default=False)
    access_users = models.BooleanField(default=False)
    access_components = models.BooleanField(default=False)
    access_perosnaltour = models.BooleanField(default=False)
    access_themedtour = models.BooleanField(default=False)
